...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://telegram.me/CodeNexus_community')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/CodeNexuscommunity"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/CodeNexuscommunity"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/CodeNexus_community')
            ],[
